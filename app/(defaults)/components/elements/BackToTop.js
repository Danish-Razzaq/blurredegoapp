...
export default function BackToTop() {
    ...
    return (
        <>
            {hasScrolled && (
                <Link id="scrollUp" href="#top" style={{ position: 'fixed', zIndex: 2147483647, justifyContent:'center', display:"flex", alignItems:'center' }}>
...
// this code to move to top smoothly and scroll to top
/* import Link from "next/link";
import { useEffect, useState } from "react";
