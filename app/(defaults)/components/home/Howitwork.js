            ...
            <section className="section pt-85 bg-worldmap">
                <div className="cnt-center container">
                    ...
                    <Image className="mb-15" src="/assets/imgs/template/logo.png" alt="transp" width={106.72} height={32} />
                        <h2 className="color-brand-2 wow animate__animated animate__fadeIn mb-20">How It Works</h2>
                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                            You choose the cities where you’d like to deliver. All deliveries are within a specific service area and delivery services vary by location. Whatever the mode or
                            requirement, we will find and book the ideal expedited shipping solution to ensure a timely delivery.
                        </p>
                    </div>
                    <div className="row mt-50">
                        <div className="col-lg-6 mb-30 ">
                            <div className="box-image-how  " >
                                <img className="w-100 wow animate__animated animate__fadeIn" src="/assets/imgs/page/homepage1/how-it-work.png" alt="transp" />
                                <div className="box-info-bottom-img" style={{backgroundColor:'red'}}>
                                    <div className="image-play"> 
                                        <img className="mb-15 bg-white rounded-full  wow animate__animated animate__fadeIn" src="/assets/imgs/template/icons/play.svg" alt="transp" />
                                    </div>
