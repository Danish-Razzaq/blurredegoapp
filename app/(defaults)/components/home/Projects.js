import Project1Slider from "../slider/ProjectSlider";
            ...
            <section className="section bg-what-done pb-95 pt-110">
                <div className="container cnt-center">
                    ...
                    <div className="row align-items-end">
                        ...
                        <div className="col-lg-2 col-md-4 mb-30 max-md:w-44 text-md-end text-start items-end"><Link className="btn btn-brand-1 hover-up wow animate__animated animate__fadeIn" href="#">
