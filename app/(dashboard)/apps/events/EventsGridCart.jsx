            ...
            <div className="space-y-4 p-4">
                ...
                <div className="flex gap-2 max-lg:flex-col ">
                    ...
                    <button
                        ...
                        className="w-full flex-1 cursor-pointer items-center justify-center text-nowrap rounded-md bg-red-500 px-1 py-3 text-sm font-medium text-white
                                      transition-colors hover:bg-red-600 lg:flex-1"
                    >
                ...
                <Link
                    ...
                    className="flex w-full items-center justify-center text-nowrap rounded-md bg-red-500 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-red-600 lg:flex-1"
                >
