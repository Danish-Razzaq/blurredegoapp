import IconCalendar from '@/public/icon/icon-calendar';
import IconClock from '@/public/icon/icon-clock';
import IconCoffee from '@/public/icon/icon-coffee';
import IconCreditCard from '@/public/icon/icon-credit-card';
import IconDribbble from '@/public/icon/icon-dribbble';
import IconGithub from '@/public/icon/icon-github';
import IconMail from '@/public/icon/icon-mail';
import IconMapPin from '@/public/icon/icon-map-pin';
import IconPencilPaper from '@/public/icon/icon-pencil-paper';
import IconPhone from '@/public/icon/icon-phone';
import IconShoppingBag from '@/public/icon/icon-shopping-bag';
import IconTag from '@/public/icon/icon-tag';
                ...
                <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="panel">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <Link href="/users/user-account-settings" className="btn btn-lg-d  btn-primary rounded-full p-2 ltr:ml-auto rtl:mr-auto">
                                <IconPencilPaper />
                            </Link>
                        </div>
                        <div className="mb-5">
                            ...
                            <ul className="mt-7 flex items-center justify-center gap-2">
                                <li>
                                    <button className="btn btn-lg-d  btn-info flex h-10 w-10 items-center justify-center rounded-full p-0">
                                        <IconTwitter className="h-5 w-5" />
                                    </button>
                                </li>
                                <li>
                                    <button className="btn btn-lg-d  btn-danger flex h-10 w-10 items-center justify-center rounded-full p-0">
                                        <IconDribbble />
                                    </button>
                                </li>
                                <li>
                                    <button className="btn btn-lg-d  btn-dark flex h-10 w-10 items-center justify-center rounded-full p-0">
                                        <IconGithub />
                                    </button>
                                </li>
                            </ul>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div className="panel">
                        <div className="mb-10 flex items-center justify-between">
                            ...
                            <button className="btn btn-lg-d  btn-primary">Renew Now</button>
                        </div>
                        <div className="group">
