'use client';
import IconDollarSignCircle from '@/public/icon/icon-dollar-sign-circle';
import IconFacebook from '@/public/icon/icon-facebook';
import IconGithub from '@/public/icon/icon-github';
import IconHome from '@/public/icon/icon-home';
                        ...
                        <div className="flex flex-col sm:flex-row">
                            ...
                            <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                ...
                                <div className="mt-3 sm:col-span-2">
                                    <button type="button" className="btn btn-lg-d  btn-primary">
                                        Save
                                    </button>
                                </div>
                            </div>
                ...
                <div>
                    <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                        <div className="panel">
                                ...
                                <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                    <div className="flex items-start justify-between py-3">
                                        ...
                                        <div className="flex items-start justify-between ltr:ml-auto rtl:mr-auto">
                                            <button className="btn btn-lg-d  btn-dark">Edit</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                            ...
                            <button className="btn btn-lg-d  btn-primary">Add Address</button>
                        </div>
                        <div className="panel">
                            <div className="mb-5">
                            ...
                            <button className="btn btn-lg-d  btn-primary">Add Payment Method</button>
                        </div>
                    </div>
                ...
                <div >
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                        <div className="panel space-y-5">
                            ...
                            <button className="btn btn-lg-d  btn-secondary">Clear</button>
                        </div>
                        <div className="panel space-y-5">
                        ...
                        <div className="panel space-y-5">
                            ...
                            <button className="btn btn-lg-d  btn-danger btn-delete-account">Delete my account</button>
                        </div>
                    </div>
                </div>
            ) : (
