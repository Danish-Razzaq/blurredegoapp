...
const ComponentsAppsMembers = () => {
            ...
            render: (item) => {
                return (
                    <div className="w-full">
                        <Link href={`/members/${item.id}`} className="btn btn-outline-blue w-full">
                            {' '}
                            View
                        </Link>
                    </div>
    ...
    return (
        <div>
            ...
            {value === 'list' && (
                <div className="mt-5">
                    <GenericTable columns={columns} data={filteredItems} />
                </div>
            )}
        </div>
    );
