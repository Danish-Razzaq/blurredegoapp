...
interface IconShoppinBlurred EgortProps {
    className?: string;
}

const IconShoppinBlurred Egort: FC<IconShoppinBlurred EgortProps> = ({ className }) => {
    return (
...
export default IconShoppinBlurred Egort;
